...
for (i in seq_along(years)) {
  ...
  event_link <- paste0("http://www.owgr.com/events?pageNo=1&pageSize=400&tour=Maj&year=", years[i])
...
# write a loop to get all of the event ids
...
# save the event ids
write_csv(df_01, "majors_events.csv")
