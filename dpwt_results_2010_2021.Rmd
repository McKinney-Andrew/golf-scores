...
# load the data
events <- read_csv("dpwt_owgr_events.csv")
...
df_01 <-
  ...
  filter(year != 2022) %>%
  filter(
    event != "WGC - Accenture Match Play Championship",
    ...
    event != "Volvo World Match Play Championship",
    event != "Saltire Energy Paul Lawrie Match Play",
    event != "Aberdeen Asset Management Paul Lawrie Match Play",
    event != "Belgian Knockout",
    event != "ISPS HANDA World Super 6 Perth",
    event != "ISPS Handa World Super 6 Perth",
    event != "Aphrodite Hills Cyprus Showdown",
    year != 2012 | event != "The Nelson Mandela Championship presented by ISPS Handa",
    year != 2014 | event != "Portugal Masters",
    year != 2014 | event != "Madeira Islands Open – Portugal – BPI",
    year != 2021 | event != "Joburg Open"
  )
...
write_csv(results, "dpwt_results_2010_2021.csv")
